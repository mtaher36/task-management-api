/*
  ...
  - You are about to drop the column `notified` on the `tbl_subtasks` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `tbl_subtasks` DROP COLUMN `notified`,
