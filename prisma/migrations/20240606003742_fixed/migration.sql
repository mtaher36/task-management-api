/*
  ...
  - You are about to drop the column `profileImage` on the `tbl_users` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `tbl_users` DROP COLUMN `profileImage`,
    ADD COLUMN `profile_image` VARCHAR(100) NULL,
    MODIFY `updatedAt` TIMESTAMP NOT NULL,
