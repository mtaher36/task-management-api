/*
  ...
  - You are about to drop the column `notified` on the `tbl_notifications` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `tbl_notifications` DROP COLUMN `notified`;
...
-- AlterTable
ALTER TABLE `tbl_tasks` ADD COLUMN `notified` BOOLEAN NOT NULL DEFAULT false,
