/*
  ...
  - You are about to drop the column `due_date` on the `tbl_subtasks` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `tbl_subtasks` DROP COLUMN `due_date`,
